...
//            if (normalizedIgnoreNodes != null && normalizedIgnoreNodes.contains(xpath)) {
//                return ComparisonResult.EQUAL;
//            }
//            if (normalizedIgnoreTextNodes != null && xpath != null && normalizedIgnoreTextNodes.contains(xpath) &&
    ...
    public void compareXMLFiles() {
        ...
        try {
            ...
            if (!areEqual) {
                ...
                Report.updateTestLog(Action, "Differences detected in XML files comparison, consult log for details", Status.DEBUG);
            } else {
